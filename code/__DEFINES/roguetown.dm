...
#define HEAVYREVOLVERSHOT list('sound/combat/ranged/garlandfire.ogg')
#define WEBLEYSHOT list('sound/combat/ranged/webleyfire.ogg')
#define COLTSHOT list('sound/combat/ranged/colt_fire.ogg')
